...
@ControllerAdvice()
public class CustomerNotFoundExceptionHandling extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleNoSuchElementException(HttpServletRequest request,CustomerNotFoundException ex){
		return buildExceptionResponse(new CustomerNotFoundResponse(HttpStatus.NOT_FOUND,LocalDateTime.now(),ex.getMessage()));
